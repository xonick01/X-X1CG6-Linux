...
#Software Add/Remove
sudo apt -y update
sudo apt -y remove gnome-characters gnome-font-viewer gnome-characters gnome-logs gnome-user-docs yelp software-properties-* gnome-accessibility-themes gnome-calculator gnome-clocks gnome-system-monitor gnome-text-editor gnome-keyring* evince
sudo apt -y upgrade
...
dconf write /org/gnome/shell/extensions/dash-to-dock/dock-positi '"BOTTOM"'
